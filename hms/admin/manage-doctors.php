...
<?php include('include/sidebar.php');?>
			<div class="app-content" style="background: #66ff33">
				
						<?php include('include/header.php');?>
					
				<!-- end: TOP NAVBAR -->
				<div class="main-content" >
					<div class="wrap-content container" id="container" style="background: #b3ffff">
						<!-- start: PAGE TITLE -->
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8" style="background:url(add-doc.jpg);">
						...
						<!-- end: PAGE TITLE -->
						<!-- start: BASIC EXAMPLE -->
						<div class="container-fluid container-fullw bg-white" style="background:url(add-doc.jpg);">
